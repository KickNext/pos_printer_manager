...
Future<void> main() async {
  await _generateExportFile(
    sourceDir: 'lib/src/',
    exportFile: 'lib/pos_printer_manager.dart',
  );
}
...
Future<void> _generateExportFile({
  ...
  exportLines.add("export 'package:pos_printers/pos_printers.dart';");
  final exportContent = exportLines.join('\n');
  File(
    exportFile,
  ).writeAsStringSync('// Auto-generated exports\n\n$exportContent\n');
